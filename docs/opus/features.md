...
`module_content.paragraphs[].link_card.match` 对象:
...
`module_content.paragraphs[].link_card.match.match_info` 对象:
...
`module_content.paragraphs[].link_card.match.match_info.left_team` 对象:
...
`module_content.paragraphs[].link_card.match.match_info.right_team` 对象:
